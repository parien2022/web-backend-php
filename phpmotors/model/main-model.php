...
function getClassifications() {
    ...
    //Create a connection object fro the phpmotors connection function
    $db = phpmotorsConnect();
    ...
    $stmt->closeCursor();
    //The next line sends the array of the data back to where the function was called (this should be the controller)
